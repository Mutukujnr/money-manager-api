...
import com.digitalvortex.moneymanager.service.ExcelService;
...
public class ExcelController {
    ...
    public void downloadIncomeExcel(HttpServletResponse response) throws IOException {
        ...
        excelService.writeIncomesToExcel(response.getOutputStream(), incomeService.incomesForCurrentUser());
    ...
    public void downloadExpenseExcel(HttpServletResponse response) throws IOException {
        ...
        response.setContentType("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
        response.setHeader("Content-Disposition","attachment; filename=income.xlsx");
        excelService.writeExpensesToExcel(response.getOutputStream(), expenseService.expensesForCurrentUser());
